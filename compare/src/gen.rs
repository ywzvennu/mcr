...
//! mce — at every ply we pick a uniformly random legal move from the seeded PRNG
...
//! generated position. shakmaty diverges from mce in a few documented spots, so
...
//!   up, …): shakmaty stops expanding such a line while mce keeps counting. We
//!   therefore stop a game as soon as mce reports an [`Outcome`], and we never
...
/// Map a variant key to the mce [`VariantId`] used to seed games.
...
/// across the game. Stops a game early at any mce-reported outcome (never
