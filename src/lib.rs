...
pub use crate::variant::{
    perft_variant, Atomic, AtomicRules, CastleGeometry, CheckCounters, Chess, Chess960,
    Chess960Rules, ChessRules, Horde, HordeRules, KingOfTheHill, KingOfTheHillRules, RacingKings,
    RacingKingsRules, ThreeCheck, ThreeCheckRules, Variant, VariantId, VariantPosition,
    VariantState,
};
