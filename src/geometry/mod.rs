...
pub use position::{
    ...
    GenericState, PlayerView, Undo, WideFenError, WideMoveList, WideOutcome,
};
...
pub use variants::{
    ...
    AseanRules, Atomar, AtomarRules, Berolina, BerolinaRules, Bughouse, BughouseRules, Cambodian,
    CambodianRules, CannonShogi, CannonShogiRules, Capablanca, CapablancaRules, Capahouse,
    CapahouseRules, Caparandom, CaparandomRules, Centaur, CentaurRules, Chak, ChakRules,
    Chancellor, ChancellorRules, Chaturanga, ChaturangaRules, CheckShogi, CheckShogiRules, Chennis,
    ChennisRules, Chessgi, ChessgiRules, Chigorin, ChigorinRules, Chu, ChuRules, Codrus,
    CodrusRules, Coregal, CoregalRules, Courier, CourierRules, Dai, DaiRules, Dobutsu,
    DobutsuRules, Dragon, DragonRules, Duck, DuckRules, Embassy, EmbassyRules, Empire, EmpireRules,
    EuroShogi, EuroShogiRules, Extinction, ExtinctionRules, FiveCheck, FiveCheckRules, FogOfWar,
    FogOfWarRules, Gardner, GardnerRules, Georgian, GeorgianRules, Giveaway, GiveawayRules,
    Gorogoro, GorogoroRules, Gothic, GothicRules, Grand, GrandRules, Grandhouse, GrandhouseRules,
    Grasshopper, GrasshopperRules, Gustav3, Gustav3Rules, HoppelPoppel, HoppelPoppelRules, Janggi,
    JanggiRules, Janus, JanusRules, Jieqi, JieqiRules, Judkins, JudkinsRules, Karouk, KaroukRules,
    Khans, KhansRules, Kinglet, KingletRules, Knightmate, KnightmateRules, Koedem, KoedemRules,
    Kyotoshogi, KyotoshogiRules, Legan, LeganRules, LoopChess, LoopChessRules, Losalamos,
    LosalamosRules, Losers, LosersRules, Makpong, MakpongRules, Makruk, MakrukRules, Manchu,
    ...
    NewzealandRules, Nightrider, NightriderRules, Nocastle, NocastleRules, Nocheckatomic,
    NocheckatomicRules, OkisakiShogi, OkisakiShogiRules, Omicron, OmicronRules, Opulent,
