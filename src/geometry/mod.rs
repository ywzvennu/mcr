...
pub use variants::{
    Capablanca, CapablancaRules, Duck, DuckRules, Empire, EmpireRules, Grand, GrandRules,
    ...
    Shatar, ShatarRules, Shinobi, ShinobiRules, Shogi, ShogiRules, Sittuyin, SittuyinRules,
