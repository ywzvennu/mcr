...
pub use variants::{
    ...
    ModernRules, Nocastle, NocastleRules, Opulent, OpulentRules, Orda, OrdaRules, Ordamirror,
    OrdamirrorRules, Pawnback, PawnbackRules, Pawnsideways, PawnsidewaysRules, Perfect,
    PerfectRules, Placement, PlacementRules, Pocketknight, PocketknightRules, Seirawan,
