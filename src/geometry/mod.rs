...
pub use variants::{
    ...
    ChennisRules, Chigorin, ChigorinRules, Chu, ChuRules, Coregal, CoregalRules, Courier,
    ...
    ExtinctionRules, FogOfWar, FogOfWarRules, Georgian, GeorgianRules, Gorogoro, GorogoroRules,
    Gothic, GothicRules, Grand, GrandRules, Grandhouse, GrandhouseRules, HoppelPoppel,
    ...
    KnightmateRules, Kyotoshogi, KyotoshogiRules, Legan, LeganRules, Makpong, MakpongRules, Makruk,
    MakrukRules, Manchu, ManchuRules, Mansindam, MansindamRules, Micro, MicroRules, Minishogi,
    MinishogiRules, Minixiangqi, MinixiangqiRules, Modern, ModernRules, Nocastle, NocastleRules,
    Opulent, OpulentRules, Orda, OrdaRules, Ordamirror, OrdamirrorRules, Pawnback, PawnbackRules,
    Pawnsideways, PawnsidewaysRules, Placement, PlacementRules, Pocketknight, PocketknightRules,
