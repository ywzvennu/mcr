...
pub use variants::{
    ...
    ModernRules, Nightrider, NightriderRules, Nocastle, NocastleRules, Opulent, OpulentRules, Orda,
    OrdaRules, Ordamirror, OrdamirrorRules, Pawnback, PawnbackRules, Pawnsideways,
    PawnsidewaysRules, Perfect, PerfectRules, Placement, PlacementRules, Pocketknight,
