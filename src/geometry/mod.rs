...
pub use variants::{
    ...
    FogOfWarRules, Gorogoro, GorogoroRules, Gothic, GothicRules, Grand, GrandRules, Grandhouse,
    GrandhouseRules, HoppelPoppel, HoppelPoppelRules, Janggi, JanggiRules, Jieqi, JieqiRules,
