...
pub use variants::{
    ...
    ChancellorRules, CheckShogi, CheckShogiRules, Chennis, ChennisRules, Chigorin, ChigorinRules,
    Chu, ChuRules, Coregal, CoregalRules, Courier, CourierRules, Dai, DaiRules, Dobutsu,
    DobutsuRules, Dragon, DragonRules, Duck, DuckRules, Embassy, EmbassyRules, Empire, EmpireRules,
    EuroShogi, EuroShogiRules, Extinction, ExtinctionRules, FogOfWar, FogOfWarRules, Georgian,
    GeorgianRules, Gorogoro, GorogoroRules, Gothic, GothicRules, Grand, GrandRules, Grandhouse,
    GrandhouseRules, HoppelPoppel, HoppelPoppelRules, Janggi, JanggiRules, Janus, JanusRules,
    Jieqi, JieqiRules, Judkins, JudkinsRules, Karouk, KaroukRules, Khans, KhansRules, Kinglet,
    KingletRules, Knightmate, KnightmateRules, Kyotoshogi, KyotoshogiRules, Makpong, MakpongRules,
    ...
    NocastleRules, Opulent, OpulentRules, Orda, OrdaRules, Ordamirror, OrdamirrorRules, Pawnback,
    PawnbackRules, Pawnsideways, PawnsidewaysRules, Placement, PlacementRules, Pocketknight,
