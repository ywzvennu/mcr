...
pub use variants::{
    ...
    AseanRules, Berolina, BerolinaRules, Bughouse, BughouseRules, Cambodian, CambodianRules,
    CannonShogi, CannonShogiRules, Capablanca, CapablancaRules, Capahouse, CapahouseRules,
    Caparandom, CaparandomRules, Centaur, CentaurRules, Chak, ChakRules, Chancellor,
    ChancellorRules, Chaturanga, ChaturangaRules, CheckShogi, CheckShogiRules, Chennis,
    ChennisRules, Chigorin, ChigorinRules, Chu, ChuRules, Codrus, CodrusRules, Coregal,
    CoregalRules, Courier, CourierRules, Dai, DaiRules, Dobutsu, DobutsuRules, Dragon, DragonRules,
    Duck, DuckRules, Embassy, EmbassyRules, Empire, EmpireRules, EuroShogi, EuroShogiRules,
    Extinction, ExtinctionRules, FogOfWar, FogOfWarRules, Gardner, GardnerRules, Georgian,
    GeorgianRules, Giveaway, GiveawayRules, Gorogoro, GorogoroRules, Gothic, GothicRules, Grand,
    GrandRules, Grandhouse, GrandhouseRules, Grasshopper, GrasshopperRules, HoppelPoppel,
    HoppelPoppelRules, Janggi, JanggiRules, Janus, JanusRules, Jieqi, JieqiRules, Judkins,
    JudkinsRules, Karouk, KaroukRules, Khans, KhansRules, Kinglet, KingletRules, Knightmate,
    KnightmateRules, Kyotoshogi, KyotoshogiRules, Legan, LeganRules, Losalamos, LosalamosRules,
    Losers, LosersRules, Makpong, MakpongRules, Makruk, MakrukRules, Manchu, ManchuRules,
    Mansindam, MansindamRules, Micro, MicroRules, Minishogi, MinishogiRules, Minixiangqi,
    MinixiangqiRules, Misere, MisereRules, Modern, ModernRules, Newzealand, NewzealandRules,
    Nightrider, NightriderRules, Nocastle, NocastleRules, OkisakiShogi, OkisakiShogiRules, Opulent,
    OpulentRules, Orda, OrdaRules, Ordamirror, OrdamirrorRules, Paradigm, ParadigmRules, Pawnback,
    PawnbackRules, Pawnsideways, PawnsidewaysRules, Perfect, PerfectRules, Petrified,
    PetrifiedRules, Placement, PlacementRules, Pocketknight, PocketknightRules, Seirawan,
    ...
    ShouseRules, Sittuyin, SittuyinRules, Sortofalmost, SortofalmostRules, Spartan, SpartanRules,
    Suicide, SuicideRules, Synochess, SynochessRules, Tencubed, TencubedRules, Tenjiku,
    TenjikuRules, Threekings, ThreekingsRules, Tori, ToriRules, Torpedo, TorpedoRules, Washogi,
    WashogiRules, Xiangfu, XiangfuRules, Xiangqi, XiangqiRules, Yari, YariRules,
};
