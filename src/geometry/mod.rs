...
pub use variants::{
    ...
    Chak, ChakRules, Chancellor, ChancellorRules, CheckShogi, CheckShogiRules, Chennis,
    ChennisRules, Chigorin, ChigorinRules, Chu, ChuRules, Courier, CourierRules, Dobutsu,
