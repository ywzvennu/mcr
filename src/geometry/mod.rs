...
pub use variants::{
    ...
    CapablancaRules, Capahouse, CapahouseRules, Chak, ChakRules, Chennis, ChennisRules, Dobutsu,
    DobutsuRules, Dragon, DragonRules, Duck, DuckRules, Empire, EmpireRules, FogOfWar,
    FogOfWarRules, Gorogoro, GorogoroRules, Grand, GrandRules, Grandhouse, GrandhouseRules,
    HoppelPoppel, HoppelPoppelRules, Janggi, JanggiRules, Jieqi, JieqiRules, Khans, KhansRules,
    ...
    SynochessRules, Tori, ToriRules, Washogi, WashogiRules, Xiangfu, XiangfuRules, Xiangqi,
    XiangqiRules,
};
