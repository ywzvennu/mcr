...
pub use variants::{
    ...
    ExtinctionRules, FogOfWar, FogOfWarRules, Gardner, GardnerRules, Georgian, GeorgianRules,
    Gorogoro, GorogoroRules, Gothic, GothicRules, Grand, GrandRules, Grandhouse, GrandhouseRules,
    Grasshopper, GrasshopperRules, HoppelPoppel, HoppelPoppelRules, Janggi, JanggiRules, Janus,
    JanusRules, Jieqi, JieqiRules, Judkins, JudkinsRules, Karouk, KaroukRules, Khans, KhansRules,
    Kinglet, KingletRules, Knightmate, KnightmateRules, Kyotoshogi, KyotoshogiRules, Legan,
    LeganRules, Losalamos, LosalamosRules, Makpong, MakpongRules, Makruk, MakrukRules, Manchu,
    ManchuRules, Mansindam, MansindamRules, Micro, MicroRules, Minishogi, MinishogiRules,
    Minixiangqi, MinixiangqiRules, Modern, ModernRules, Newzealand, NewzealandRules, Nightrider,
    NightriderRules, Nocastle, NocastleRules, OkisakiShogi, OkisakiShogiRules, Opulent,
