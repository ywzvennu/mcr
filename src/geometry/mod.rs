...
pub use variants::{
    ...
    Chak, ChakRules, Chancellor, ChancellorRules, Chennis, ChennisRules, Chigorin, ChigorinRules,
    Chu, ChuRules, Courier, CourierRules, Dobutsu, DobutsuRules, Dragon, DragonRules, Duck,
    DuckRules, Embassy, EmbassyRules, Empire, EmpireRules, FogOfWar, FogOfWarRules, Gorogoro,
    ...
    MinishogiRules, Minixiangqi, MinixiangqiRules, Opulent, OpulentRules, Orda, OrdaRules,
