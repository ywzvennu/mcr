...
pub use variants::{
    ...
    GrandRules, Grandhouse, GrandhouseRules, Grasshopper, GrasshopperRules, Gustav3, Gustav3Rules,
    HoppelPoppel, HoppelPoppelRules, Janggi, JanggiRules, Janus, JanusRules, Jieqi, JieqiRules,
    Judkins, JudkinsRules, Karouk, KaroukRules, Khans, KhansRules, Kinglet, KingletRules,
    Knightmate, KnightmateRules, Koedem, KoedemRules, Kyotoshogi, KyotoshogiRules, Legan,
    LeganRules, Losalamos, LosalamosRules, Losers, LosersRules, Makpong, MakpongRules, Makruk,
    MakrukRules, Manchu, ManchuRules, Mansindam, MansindamRules, Micro, MicroRules, Minishogi,
    MinishogiRules, Minixiangqi, MinixiangqiRules, Misere, MisereRules, Modern, ModernRules,
    Newzealand, NewzealandRules, Nightrider, NightriderRules, Nocastle, NocastleRules,
