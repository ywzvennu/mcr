...
pub use variants::{
    ...
    Extinction, ExtinctionRules, FiveCheck, FiveCheckRules, FogOfWar, FogOfWarRules, Gardner,
    GardnerRules, Georgian, GeorgianRules, Giveaway, GiveawayRules, Gorogoro, GorogoroRules,
    Gothic, GothicRules, Grand, GrandRules, Grandhouse, GrandhouseRules, Grasshopper,
    GrasshopperRules, Gustav3, Gustav3Rules, HoppelPoppel, HoppelPoppelRules, Janggi, JanggiRules,
    Janus, JanusRules, Jieqi, JieqiRules, Judkins, JudkinsRules, Karouk, KaroukRules, Khans,
    KhansRules, Kinglet, KingletRules, Knightmate, KnightmateRules, Koedem, KoedemRules,
    Kyotoshogi, KyotoshogiRules, Legan, LeganRules, Losalamos, LosalamosRules, Losers, LosersRules,
    Makpong, MakpongRules, Makruk, MakrukRules, Manchu, ManchuRules, Mansindam, MansindamRules,
    Micro, MicroRules, Minishogi, MinishogiRules, Minixiangqi, MinixiangqiRules, Misere,
    MisereRules, Modern, ModernRules, Newzealand, NewzealandRules, Nightrider, NightriderRules,
    Nocastle, NocastleRules, OkisakiShogi, OkisakiShogiRules, Omicron, OmicronRules, Opulent,
    ...
    PetrifiedRules, Placement, PlacementRules, Pocketknight, PocketknightRules, Raazuvaa,
    RaazuvaaRules, Seirawan, SeirawanRules, Shako, ShakoRules, Shatar, ShatarRules, Shatranj,
    ...
    Spartan, SpartanRules, Suicide, SuicideRules, Supply, SupplyRules, Synochess, SynochessRules,
    Tencubed, TencubedRules, Tenjiku, TenjikuRules, Threekings, ThreekingsRules, Tori, ToriRules,
    Torpedo, TorpedoRules, Washogi, WashogiRules, Wolf, WolfRules, Xiangfu, XiangfuRules, Xiangqi,
    XiangqiRules, Yari, YariRules,
};
