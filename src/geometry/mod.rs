...
pub use variants::{
    ...
    Shogi, ShogiRules, Shogun, ShogunRules, Shouse, ShouseRules, Sittuyin, SittuyinRules,
    Sortofalmost, SortofalmostRules, Spartan, SpartanRules, Suicide, SuicideRules, Synochess,
