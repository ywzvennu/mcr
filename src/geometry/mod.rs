...
pub use variants::{
    ...
    Manchu, ManchuRules, Mansindam, MansindamRules, Micro, MicroRules, Minishogi, MinishogiRules,
    Minixiangqi, MinixiangqiRules, Modern, ModernRules, Nocastle, NocastleRules, Opulent,
