...
- Id: `omicron`
- Board: 12x10 (120 squares, `Omicron12x10` geometry, 128-bit backing)
...
| TencubedChampion | `**x` | leaper / stepper | no |
...
- Promotes to: Wizard, TencubedChampion, Queen, Rook, Bishop, Knight
- Promotion zone rank(s): 9
- Forced on the furthest rank

## Castling

- Castling rank (White): 2
- Kingside: king lands on the i-file, castling with the Rook
- Queenside: king lands on the e-file, castling with the Rook
