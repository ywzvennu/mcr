...
- Validation oracle: Fairy-Stockfish (`UCI_Variant losers`)
...
- Extinction: win when the total piece count falls to 1 or fewer
- Being checkmated wins for the mated side
