...
- Id: `chancellor`
- Board: 9x9 (81 squares, `Chess9x9` geometry, 128-bit backing)
- Validation oracle: Fairy-Stockfish (`UCI_Variant chancellor`)
...
```
rnbqkenbr/ppppppppp/9/9/9/9/9/PPPPPPPPP/RNBQKENBR w KQkq - 0 1
```
...
- Promotes to: Knight, Bishop, Rook, Queen, Elephant
