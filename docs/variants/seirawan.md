...
- Validation oracle: Fairy-Stockfish (`UCI_Variant seirawan`)
...
```
rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR[HEhe] w KQkqBCDFGbcdfg - 0 1
```
...
- Seirawan gating of reserve pieces
