...
- Validation oracle: Fairy-Stockfish (`UCI_Variant petrified`)
...
- May also step one square sideways
...
- Petrify-on-capture — roles that turn to stone: Knight, Bishop, Rook, Queen
- The (pseudo-royal) king may not capture
