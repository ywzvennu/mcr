...
- Validation oracle: Fairy-Stockfish (`UCI_Variant shinobi`)
...
```
rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/L*N1*UK1*NL[MMALD*N] w kq - 0 1
```
...
- Promotes to: Commoner
- Promotion zone rank(s): 7, 8
