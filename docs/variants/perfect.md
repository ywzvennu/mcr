...
- Validation oracle: Fairy-Stockfish (`UCI_Variant perfect`)
...
- Promotes to: Angel, Elephant, Hawk, Queen, Rook, Bishop, Knight
...
- Queenside: king lands on the c-file, castling with the Elephant
