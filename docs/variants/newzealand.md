...
- Validation oracle: Fairy-Stockfish (`UCI_Variant newzealand`)
...
- Promotes to: Queen, Rookni, Bishop, Lancer
...
- Kingside: king lands on the g-file, castling with the Rookni
- Queenside: king lands on the c-file, castling with the Rookni
