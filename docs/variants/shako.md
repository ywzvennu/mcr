...
- Validation oracle: Fairy-Stockfish (`UCI_Variant shako`)
...
- Promotes to: Knight, Bishop, Rook, Queen, Cannon, FersAlfil
...
- Queenside: king lands on the d-file, castling with the Rook
