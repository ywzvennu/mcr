...
- Validation oracle: Fairy-Stockfish (`UCI_Variant euroshogi`)
...
- Type: leaper / stepper
- Moves & captures:
  - single step / leap: left (-1,+0), forward-left (-1,+2), right (+1,+0), forward-right (+1,+2)
