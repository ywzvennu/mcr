...
- Validation oracle: Fairy-Stockfish (`UCI_Variant modern`)
...
```
rnbqkabnr/ppppppppp/9/9/9/9/9/PPPPPPPPP/RNBAKQBNR w KQkq - 0 1
```
...
- Promotes to: Knight, Bishop, Rook, Queen, Hawk
