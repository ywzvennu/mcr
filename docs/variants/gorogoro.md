...
- Id: `gorogoro`
- Board: 5x6 (30 squares, `Gorogoro5x6` geometry, 64-bit backing)
- Validation oracle: Fairy-Stockfish (`UCI_Variant gorogoroplus`)
...
```
sgkgs/5/1ppp1/1PPP1/5/SGKGS[NLnl] w - - 0 1
```
