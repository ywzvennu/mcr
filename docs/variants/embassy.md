...
- Validation oracle: Fairy-Stockfish (`UCI_Variant embassy`)
...
- Promotes to: Elephant, Hawk, Queen, Rook, Bishop, Knight
...
- Kingside: king lands on the h-file, castling with the Rook
- Queenside: king lands on the b-file, castling with the Rook
