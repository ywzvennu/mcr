...
- Validation oracle: Fairy-Stockfish (`UCI_Variant karouk`)
...
- Giving check wins the game outright

**Draw / adjudication rules**

- Counting endgame: Cambodian

## Special mechanics

- One-time first-move leap (Cambodian King / Met)
