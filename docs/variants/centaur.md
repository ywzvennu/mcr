...
- Id: `centaur`
- Board: 10x8 (80 squares, `Cap10x8` geometry, 128-bit backing)
- Validation oracle: Fairy-Stockfish (`UCI_Variant centaur`)
...
```
rwnbqkbnwr/pppppppppp/10/10/10/10/PPPPPPPPPP/RWNBQKBNWR w KQkq - 0 1
```
...
- Promotes to: Knight, Bishop, Rook, Queen, Kheshig
