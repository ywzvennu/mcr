...
- Validation oracle: Fairy-Stockfish (`UCI_Variant suicide`)
...
- Promotes to: Knight, Bishop, Rook, Queen, King
...
- Extinction: win when the total piece count falls to 0 or fewer

**Draw / adjudication rules**

- Stalemate is decided by piece count: the side with fewer pieces wins
