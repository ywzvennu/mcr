...
- Validation oracle: Fairy-Stockfish (`UCI_Variant opulent`)
...
- Type: leaper / stepper
- Moves & captures:
  - single step / leap: back-left (-2,-1), forward-left (-2,+1), back-left (-1,-2), left (-1,+0), forward-left (-1,+2), backward (+0,-1), forward (+0,+1), back-right (+1,-2), right (+1,+0), forward-right (+1,+2), back-right (+2,-1), forward-right (+2,+1)
...
- Promotes to: OpulentKnight, Bishop, Rook, Wizard, OpulentLion, Queen, Hawk, Elephant
