...
- Validation oracle: Fairy-Stockfish (`UCI_Variant horde`)
...
- Double-step allowed from rank(s): 1, 2
...
- Elimination: a side reduced to no material loses (Horde)
...
- The two sides start with different armies
