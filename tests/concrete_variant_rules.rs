...
/// `VariantRef::ALL` spans both families: the nine concrete plus the ninety wide.
#[test]
fn all_spans_both_families() {
    ...
    assert_eq!(wide, 90, "ninety wide variants");
    assert_eq!(VariantRef::ALL.len(), 99, "ninety-nine variants in all");
}
