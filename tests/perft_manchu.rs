...
//! `mce::geometry::Manchu::perft` and by Fairy-Stockfish (FSF,
...
/// The Manchu starting FEN (mce dialect): a full Black Xiangqi army, and White's
...
/// hobbled horse leaps in the open. FSF-confirmed (mce dialect of FSF's
...
/// screen `p`->`z` for the mce dialect).
