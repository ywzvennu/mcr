...
const REQUIRED: &[Required] = &[
    ...
    row(Game::Wide(WideVariantId::Atomar), "perft_atomar.rs", PerftOracle::Fsf, 4, Difffuzz::InSpecs, DrawTest::Named("capturing_the_commoner_wins")),
    ...
    row(Game::Wide(WideVariantId::Chessgi), "perft_chessgi.rs", PerftOracle::Fsf, 3, Difffuzz::InSpecs, DrawTest::None),
    ...
    row(Game::Wide(WideVariantId::Fivecheck), "perft_5check.rs", PerftOracle::Fsf, 4, Difffuzz::InSpecs, DrawTest::Named("fifth_check_wins_before_checkmate")),
    ...
    row(Game::Wide(WideVariantId::LoopChess), "perft_loop.rs", PerftOracle::Fsf, 3, Difffuzz::InSpecs, DrawTest::None),
    ...
    row(Game::Wide(WideVariantId::Nocheckatomic), "perft_nocheckatomic.rs", PerftOracle::Fsf, 4, Difffuzz::InSpecs, DrawTest::Named("capture_explodes_adjacent_non_pawns")),
    ...
    row(Game::Wide(WideVariantId::Raazuvaa), "perft_raazuvaa.rs", PerftOracle::Fsf, 4, Difffuzz::InSpecs, DrawTest::None),
